-- Performance/safety hardening: prevent rapid duplicate messages atomically.
...
begin
  if p_user_id is null or p_name is null or p_country is null or p_subdivision is null then raise exception 'invalid_profile'; end if;
