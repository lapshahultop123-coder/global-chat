...
const checks=[];
const privateShieldVideoPattern=/private-shield\.mp4/;
...
ok('private clean shield/lock animation',/private-shield-animation/.test(app)&&/private-shield-video/.test(app)&&/private-shield-lock\.mp4/.test(app)&&fs.existsSync(path.join(root,'public/animations/private-shield-lock.mp4'))&&!/ShieldCheck/.test(app));
...
ok('voice recorder has no live waveform UI',!/voice-recorder[\s\S]{0,1200}recording-wave/.test(app));
