...
ok('private clean shield/lock animation',/private-shield-animation/.test(app)&&/private-shield-video/.test(app)&&/private-shield-lock-transparent\.webm/.test(app)&&fs.existsSync(path.join(root,'public/animations/private-shield-lock-transparent.webm'))&&!/ShieldCheck/.test(app));
