...
DO $$ BEGIN
  ...
  ALTER TABLE public.message_reactions ADD CONSTRAINT message_reactions_reaction_check
    CHECK (reaction IN (U&'\+1F44D',U&'\+2764\+FE0F',U&'\+1F602',U&'\+1F62E',U&'\+1F622',U&'\+1F621',U&'\+1F389',U&'\+1F64F'));
...
BEGIN
  ...
  IF p_reaction NOT IN (U&'\+1F44D',U&'\+2764\+FE0F',U&'\+1F602',U&'\+1F62E',U&'\+1F622',U&'\+1F621',U&'\+1F389',U&'\+1F64F') THEN RAISE EXCEPTION 'Invalid reaction'; END IF;
