...
import { AlertTriangle, ArrowDown, Bell, BookOpen, Bug, Check, ChevronDown, Clock3, Copy, Globe2, Image, KeyRound, LockKeyhole, MessageCircle, Mic, MicOff, MoreVertical, Palette, Pause, Pencil, Play, Plus, Reply as ReplyIcon, Search, Send, Settings, Smile, Trash2, UserRound, Users, Volume2, Wifi, WifiOff, X } from 'lucide-react';
  ...
  return <div className="chat-app">
    <header className="topbar">
      ...
      <div className="top-actions">
        ...
        <button className="private-top-btn your-private-chats-top-btn" onClick={()=>{setYourPrivateChatsOpen(true);void loadYourPrivateChats()}} aria-label="Your Private Chats" title="Your Private Chats"><span className="your-private-chats-icon"><Users size={17}/></span><span className="private-top-label">YOUR PRIVATE CHATS</span></button>
